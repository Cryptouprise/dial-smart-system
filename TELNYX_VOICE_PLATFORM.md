...
5. [Tools & Function Calling (Deep)](#tools--function-calling-deep-technical-detail)
6. [Voice & Speech Configuration](#voice--speech-configuration)
7. [Memory & Dynamic Variables (Deep)](#memory--dynamic-variables)
8. [Webhooks & Events](#webhooks--events)
9. [Outbound Calling](#outbound-calling)
10. [Scheduled Events API (Deep)](#scheduled-events-api-deep-technical-detail)
11. [AI Missions (Multi-Call Orchestration)](#ai-missions-multi-call-orchestration)
12. [Multi-Agent Handoff (Deep)](#multi-agent-handoff-deep-technical-detail)
13. [Versioning, A/B Testing & Canary (Deep)](#versioning-ab-testing--canary-deployments-deep-technical-detail)
14. [Call Control Integration](#call-control-integration)
15. [AMD / Answering Machine Detection (Deep)](#answering-machine-detection--amd-deep-technical-detail)
16. [Monitoring & Analytics (Deep)](#monitoring--analytics-deep-technical-detail)
17. [Knowledge Base / RAG (Deep)](#knowledge-base--rag-deep-technical-detail)
18. [Pricing](#pricing)
19. [Telnyx vs Retell AI Comparison](#telnyx-vs-retell-ai-comparison)
20. [Node.js SDK](#nodejs-sdk)
21. [Current Codebase Integration Status](#current-codebase-integration-status)
22. [Integration Architecture Plan](#integration-architecture-plan)
23. [Key Sources](#key-sources)
