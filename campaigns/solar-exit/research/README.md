# Solar Exit research and copy bundle
...
- Fixed AI/seller/opt-out/recording opening
- Speed-to-lead and requested re-contact copy
- Neutral qualification flow
- Objection handling
- Conservative voicemail copy behind a disabled certification gate
- Seller-wide DNC and consent-revocation behavior
- Disposition taxonomy and urgent/legal/safety escalation language
- 100-point QA rubric, hard-failure list, and adversarial scenario suite

## What still blocks activation

- authoritative database baseline and staging installation;
- exact legal entity/DBA and service/fee classification;
- counsel-approved consent form, claims, state allowlist, and recording matrix;
- evidence that existing ad leads contain valid Elite Solar Recovery artificial-voice telemarketing consent;
