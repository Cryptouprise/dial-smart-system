...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <Helmet>
        <title>Call Boss — AI Predictive Dialer | Book More Appointments Automatically</title>
        <meta name="description" content="Call Boss is the AI-powered predictive dialer that automates outreach, follow-up, and appointment setting. Built for solar, insurance, legal, MCA, and more." />
        <meta name="keywords" content="AI predictive dialer, AI calling software, automated outreach, appointment setting AI, Call Boss" />
        <link rel="canonical" href="https://aicallboss.app/" />
        <meta property="og:title" content="Call Boss — AI Predictive Dialer" />
        <meta property="og:description" content="Automate your outreach, follow-up, and appointment setting with AI. 10x your contact rate without hiring more reps." />
        <meta property="og:url" content="https://aicallboss.app/" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://aicallboss.app/pwa-512x512.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Call Boss — AI Predictive Dialer" />
        <meta name="twitter:description" content="Automate your outreach, follow-up, and appointment setting with AI. 10x your contact rate without hiring more reps." />
        <meta name="twitter:image" content="https://aicallboss.app/pwa-512x512.png" />
      </Helmet>
      {/* Background effects */}
