...
import {
  ...
  MessageSquare, Target, Layers, Star
} from 'lucide-react';
...
const features = [
  {
    ...
    description: 'Self-optimizing engine that learns from every call. Adjusts scripts, timing, and pacing in real-time.',
    accent: 'from-blue-500/20 to-purple-500/20',
  },
  {
    icon: Phone,
    title: 'Predictive Dialer',
    description: 'Multi-carrier support with Retell AI, Twilio & Telnyx. Adaptive pacing keeps your answer rates high.',
    accent: 'from-emerald-500/20 to-teal-500/20',
  },
  {
    icon: MessageSquare,
    title: 'AI SMS Engine',
    description: 'Context-aware conversations that nurture leads 24/7. A/B tests copy automatically and optimizes for replies.',
    accent: 'from-orange-500/20 to-amber-500/20',
  },
  {
    icon: Target,
    title: 'Lead Journey Intelligence',
    description: 'Every lead gets a personalized path. Sales psychology playbooks fire at the perfect moment.',
    accent: 'from-rose-500/20 to-pink-500/20',
  },
  {
    icon: BarChart3,
    title: 'Strategic Pattern Detection',
    description: '6 statistical algorithms discover what humans miss. Auto-generates rules from high-confidence insights.',
    accent: 'from-violet-500/20 to-indigo-500/20',
  },
  {
    icon: Shield,
    title: 'Enterprise Compliance',
    description: 'TCPA-compliant calling hours, DNC management, consent tracking, and full audit trails built in.',
...
const testimonials = [
  {
    quote: "We went from 200 calls a day to 2,000 — with the same team. Call Boss doesn't just dial, it thinks.",
    author: "Director of Sales Operations",
    company: "Enterprise Solar Co.",
    stars: 5,
  },
  {
    quote: "The AI figured out Thursday 2pm converts 3.2x better than Monday mornings. We never would've caught that.",
    author: "VP of Sales",
    company: "National Insurance Group",
    stars: 5,
  },
  {
    quote: "Our lead-to-appointment rate doubled in 3 weeks. The perpetual follow-up system is a game changer.",
    author: "Call Center Manager",
    company: "Home Services Leader",
    stars: 5,
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="animate-fade-up-delay-1 text-4xl sm:text-5xl md:text-7xl font-extrabold tracking-tight leading-[1.1] mb-6">
              <span className="text-gradient-hero">They Built Tools.</span>
              <br />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {problems.map((item, i) => {
              ...
              return (
                <div
                  key={i}
                  className="glass-card p-6 text-center card-hover-lift"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => {
              ...
              return (
                <div
                  key={i}
                  className="glass-card p-6 card-hover-lift group"
                >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                The AI-first autonomous dialer platform.
              </p>
            </div>
            <div>
