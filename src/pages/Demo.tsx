  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 pb-20 md:pb-0">
      ...
      <Helmet>
        ...
        <meta name="description" content="See Call Boss in action. Watch our AI dialer automate outreach, handle objections, and book appointments — live demo in under 2 minutes." />
        <link rel="canonical" href="https://aicallboss.app/demo" />
        <meta property="og:title" content="Live AI Dialer Demo — Call Boss" />
        <meta property="og:description" content="See Call Boss in action. Watch our AI dialer automate outreach, handle objections, and book appointments — live demo in under 2 minutes." />
